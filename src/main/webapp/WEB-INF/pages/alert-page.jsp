...
<link
	href='${pageContext.request.contextPath}/resources/css/dataTables.jqueryui.min.css'
	rel='stylesheet' type='text/css'>
<link
	href='${pageContext.request.contextPath}/resources/css/dataTables.bootstrap4.min.css'
	rel='stylesheet' type='text/css'>
<link
	href='${pageContext.request.contextPath}/resources/css/buttons.jqueryui.min.css'
	rel='stylesheet' type='text/css'>
...
<body>
    ...
    -->
			<div class="logo">
				<a href="http://localhost:8081/activiti-example/login.htm"
					class="simple-text"> Case Management </a>
			</div>
...
<script
	src="${pageContext.request.contextPath}/resources/js/dataTables.bootstrap4.min.js"></script>
...
<script
	src="${pageContext.request.contextPath}/resources/js/buttons.jqueryui.min.js"></script>
<script
...
<script
	src="${pageContext.request.contextPath}/resources/js/buttons.colVis.min.js"></script>



<script type="text/javascript">
	var abc =$.getJSON("http://localhost:8081/activiti-example/resources/json/demo.json")

	var showNotification = function() {
		var tableData = table.rows(this).data();
		$
				.notify(
						{
							icon : "notifications",
							message : "Welcome to <b>Case Management</b> - a beautiful freebie for every web developer."
	...
	var table = $('#example')
			.DataTable(
					{
						dom : 'Bfrtip',
						data : abc.responseJSON.Items.item,
						...
						columns : [
								...
								{
									"title" : "From",
									"data" : "peopleFrom.address"
								},
								{
									"title" : "To",
									"data" : "peopleTo.address"
								},
								{
									"data" : 'tags',
									bSortable : false,
									...
									render : function(data) {
										...
										return '<div class="action-buttons" onclick="showNotification()">'
												+ '<span  value="' + data + '" class="actions action-view  pull-left" title="View">'
